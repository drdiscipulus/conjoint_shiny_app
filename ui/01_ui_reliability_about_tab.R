...
tabPanel(
  ...
  fluidRow(
    ...
    tags$div(
      ...
      tags$ul(
        tags$li("Abstract: Metric conjoint studies are a popular research design in the entrepreneurship
      ...
      tags$li("All code and data used in this publication is available on the Open Science Framework:",
              tags$a(href = "https://osf.io/qpzhf/?view_only=61cd1571ec23440da1974756002a819e", "Link to Repository", target = "_blank")),
        tags$li("Our workflow should be used to evaluate the manipulated 
                variables prior to fitting the actual model - level 2 variables (measured variables) are not part of our workflow"),
